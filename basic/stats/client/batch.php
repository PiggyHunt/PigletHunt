    ...
    'results' => [
        [
            ...
            "stats" => [
                ...
                ["k" => "Player_NickName", "v" => "brianitav10"],
    ...
    'cache' => [
        [
            ...
            'offlineDataList' => [
                "keys" => [
                    "MINITOON1000",
                    "EARLY_ACCESS_POST_REWARD_PROCESS_DONE",
                    "EARLY_ACCESS_REWARD_FINAL_2",
                    "EARLY_ACCESS_FREE",
                    "IQMTC3ZH3TBT",
                    "VERSION",
                    "KREEKCRAFTVP",
                ...
                "values" => [
                    ...
                    "REDEEM_CODE_USED",
                    [
                        "BodyEquipped" => "items.body.39_body",
                        "SkinColorEquipped" => "items.skinColor.13_skinColor",
                        "FaceWearsEquipped" => "",
                        "EyesEquipped" => "items.eyes.13_eyes",
                        "MouthEquipped" => "items.mouth.2_mouth",
                        "EyesWearsEquipped" => "",
                        "BackEquipped" => "items.back.0_back",
                        "HairColorEquipped" => "items.hairColor.1_hairColor",
                        "HairEquipped" => "items.hairAndHat.19_hairAndHat",
                        "GenderEquipped" => "items.bodyType.1_bodyType",
                        "InfectedBodyEquipped" => "items.infectedSkin.11_infectedSkin",
                        "InfectedWeaponEquipped" => "items.infectedWeapon.7_infectedWeapon",
                        "InfectedAnimationEquipped" => "items.infectedKillScene.0_infectedKillScene",
                        "BadgeEquipped" => "items.badge.3_badge",
                    ],
                    "11/11/2021 11:33:39 AM",
                    "brianitav10",
                    "TRUE",
                    "TRUE",
                ],
